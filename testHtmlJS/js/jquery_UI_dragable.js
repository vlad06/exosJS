jQuery(document).ready(function($){
 ...
 // Seul le personnage #jeanne peut monter dans la voiture
 // rouge
 accept: "#jeanne",
 // Action effectuée lorsqu'on dépose un élément dans la
 // voiture rouge
 drop: function(event, ui) {
 // ui.draggable désigne l'élément déplacé,
 // exemple : #jeanne ou #boby
 // On place le personnage dans la voiture (au niveau du
 // DOM)
